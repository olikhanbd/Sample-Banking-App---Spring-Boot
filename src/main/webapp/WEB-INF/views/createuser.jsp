...
<head>
    ...
    <script type="text/javascript">
	 $(document).ready(function() {  
	   ...
	   $('#role').change(function() {     //add a listener for change
	     var selectedValue = $(this).find(":selected").val();
	   		...
	   		//var roles= $('#rolesData').val();
	   		
	   		//console.log(roles[0]);
	   
	     //var index = roles.findIndex(x => x.roleName = selectedValue);
	     //var value = roles[index].roleName;
	     
	     //console.log(index);
	     //console.log(value);
	   
	     //$('#auth_role_id').val(value);
	   });
